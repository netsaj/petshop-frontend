        ...
        <div ref="toggle" @mousedown.prevent="toggleDropdown" class="vs__dropdown-toggle">
          ...
          <span :key="getOptionKey(option)" class="vs__selected">
            ...
            <button v-if="multiple" :disabled="disabled" @click="deselect(option)" type="button" class="vs__deselect"
                    aria-label="Deselect option" ref="deselectButtons">
            ...
            <div class="vs__actions" ref="actions">
                ...
                <slot name="open-indicator" v-bind="scope.openIndicator">
                    <component :is="childComponents.OpenIndicator" v-if="!noDrop"
                               v-bind="scope.openIndicator.attributes"/>
                </slot>

                <slot name="spinner" v-bind="scope.spinner">
                    <div class="vs__spinner" v-show="mutableLoading">Cargando...</div>
                </slot>
            </div>
        </div>

        <transition :name="transition">
            <ul ref="dropdownMenu" v-if="dropdownOpen" class="vs__dropdown-menu" role="listbox"
                @mousedown.prevent="onMousedown" @mouseup="onMouseUp">
                <li
                        role="option"
                ...
                <li v-if="!filteredOptions.length" class="vs__no-options" @mousedown.stop="">
                    <slot name="no-options">No hay coincidencias.</slot>
                </li>
            </ul>
        </transition>
    </div>
...
<script type="text/babel">
    ...
    export default {
        ...
        props: {
            ...
            /**
             * Contain the key name from value
             */
            keyName: {
                type: String,
                default: "id"
